          ...
          <div class="fds-search fds-search--small" role="search">
            <div class="fds-search__bd">
              <div class="fds-search__entry fds-search__entry--grow">
                ...
                <input placeholder="Search" class="fds-input fds-input--small fds-search__input" id="searchPhrase" type="search" name="searchPhrase">
              </div>
          ...
          <div class="fds-search fds-search--small" role="search">
            <div class="fds-search__bd">
              <div class="fds-search__entry fds-search__entry--grow">
                ...
                <input placeholder="Search" class="fds-input fds-input--small fds-search__input" id="scopedSearchPhrase" type="search" name="scopedSearchPhrase">
              </div>
